  ...
  return (
    ...
    >
      ...
      <Image
        ...
        height={200}
        src={Partcile3}
        className="absolute top-0 right-0 block md:hidden object-contain animate-spin-slow"
        alt=""
      />
      <Image
        width={200}
        height={200}
        src={Partcile2}
        className="absolute top-0 left-0 block md:hidden object-contain animate-spin-slow"
        alt=""
      />
      <Image
        width={200}
        height={200}
        src={Partcile1}
        className="absolute bottom-0 right-0 block md:hidden object-contain animate-spin-slow"
        alt=""
      />
    </motion.div>
  );
