  ...
  return (
    <div className="grid justify-center mt-[100px] font-monument min-h-screen">
      <div className="grid  xl:grid-cols-[minmax(0,_540px)_minmax(0,_540px)] grid-rows-[500px] justify-center items-center gap-10 px-10">
        ...
        <p className="font-monumentBold pb-5 text-center inline xl:hidden font-bold text-3xl">{title}</p>
          <Image
            width={500}
            height={350}
            src={image}
        ...
        <div className="flex text-center xl:text-left flex-col gap-5">
          <p className="font-monumentBold hidden xl:inline font-bold text-3xl">{title}</p>
          ...
          <div className="flex flex-col items-center xl:items-end">
            <Button type="black" text="Buy now" />
          </div>
        </div>
      </div>
      {/* @ts-ignore */}
